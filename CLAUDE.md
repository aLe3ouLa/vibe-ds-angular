...
This file mirrors [`AGENTS.md`](AGENTS.md), the canonical instructions file
for all coding agents working in this repo. `.github/copilot-instructions.md`
and the nested `projects/design-system/CLAUDE.md` are short pointers at
AGENTS.md; this file is a full duplicate because it's the one Claude Code
auto-loads. When repository instructions change, update AGENTS.md and this
file together.
